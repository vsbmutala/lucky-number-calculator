...
const FEATURES = [
    {
        ...
        desc: "Get your lucky number in seconds",
    },
    {
        icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
        title: "100% Private",
        desc: "No data stored or shared",
    },
    {
        icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
        title: "Numerology Based",
        desc: "Ancient wisdom, modern tech",
    },
];
...
export default function LuckyNumberCalculator() {
    ...
    const handleCalculate = () => {
        ...
        const date = parseDateFromInput(dateOfBirth);
        calculate(date);
    };
                            ...
                            <div className="lg:w-1/2 flex flex-col items-center lg:items-center text-center lg:text-center">
                                <div className="max-w-xl animate-fade-up">
                                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/20 mb-6">
                                        ...
                                        <span className="text-violet-300 text-xs sm:text-sm font-medium tracking-wide uppercase">
                                    ...
                                    <p className="text-base sm:text-lg lg:text-xl text-slate-400 leading-relaxed mb-10 max-w-md mx-auto">
                                        Enter your date of birth and unveil the
                                        single digit the universe has assigned
                                        to you through the ancient art of
                                        numerology.
                                    </p>
